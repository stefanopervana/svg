...
<p className="it">Los Scalable Vector Graphics <a contenteditable="false" data-primary="SVGs" data-secondary="advantages" data-type="indexterm" id="idm140658634296336" className="calibre7"></a>se están volviendo cada vez más populares como medio para poner las imágenes en la web. Las ventajas del formato se pueden deducir de su nombre:</p>
...
<p className="it">En cuanto a la estructura SVG, la mayor parte del margen de beneficio puede parecer familiar para usted. La sintaxis es fácil de leer debido a las similitudes con HTML. En la raíz <code>&lt;svg&gt;</code> &nbsp;elemento,&nbsp;<a contenteditable="false" data-primary="SVG element" data-type="indexterm" id="idm140658634269648" className="calibre7"></a>vemos una declaración de <code>x</code> y <code>y</code> los valores-establecen en <code>0</code> aquí, por los puntos en la matriz de coordenadas que estamos empezando a. La anchura y la altura se designen, y verá que corresponden a los dos últimos valores de<a contenteditable="false" data-primary="SVG DOM" data-startref="svg1dom" data-type="indexterm" id="idm140658634265808" className="calibre7"></a>el <code>viewBox</code>.</p>
<p className="p">Looking at the SVG structure, most of the markup may appear familiar to you. The syntax is easy to read because of the commonalities with HTML. In the root <code>&lt;svg&gt;</code>  element, <a contenteditable="false" data-primary="SVG element" data-type="indexterm" id="idm140658634269648" className="calibre7"></a>we see a declaration of <code>x</code> and <code>y</code> values—both set to <code>0</code> here, for the points in the coordinate matrix that we’re starting at. The width and height are both designated, and you’ll see that they correspond to the last two values in <a contenteditable="false" data-primary="SVG DOM" data-startref="svg1dom" data-type="indexterm" id="idm140658634265808" className="calibre7"></a>the <code>viewBox</code>.</p>
</div>

<div className="praise" id="idm140658634267872">
<h1 className="calibre12" id="calibre_pb_2">viewBox and preserveAspectRatio</h1>

<p className="it">El SVG <code>viewBox</code> es<a contenteditable="false" data-primary="viewBox" data-type="indexterm" id="v1" className="calibre7"></a>un atributo muy poderoso, ya que permite que el lienzo SVG para ser verdaderamente infinita, mientras que el control y perfeccionar el espacio visible. Los cuatro parámetros que toma como un valor son como sigue: <code>x</code>, <code>y</code>, <code>width</code>, y <code>height</code>. Este espacio no se define en píxeles, sino más bien es un espacio más maleable que se puede ajustar a diferentes escalas. Pensar en esto como mapeo de formas y dibujos sobre un trozo de papel de gráfico (ver <a data-type="xref" href="part0006_split_002.html#fig1.2" className="calibre7">Figura 1-2</a> ).</p>
<p className="p">The SVG <code>viewBox</code> is <a contenteditable="false" data-primary="viewBox" data-type="indexterm" id="v1" className="calibre7"></a>a very powerful attribute, as it allows the SVG canvas to truly be infinite, while controlling and refining the viewable space. The four parameters it takes as a value are as follows: <code>x</code>, <code>y</code>, <code>width</code>, and <code>height</code>. This space is not defined in pixels, but rather is a more malleable space that can be adjusted to many different scales. Think of this as mapping out shapes and drawings on a piece of graph paper (see <a data-type="xref" href="part0006_split_002.html#fig1.2" className="calibre7">Figure 1-2</a>).</p>
...
<p className="it">SVG también almacena información fuera del <code>viewBox</code> área. Si nos movemos una forma fuera de este espacio, vamos a ver lo que se muestra en <a data-type="xref" href="part0006_split_002.html#fig1.4" className="calibre7">la Figura 1-4</a> .</p>
<p className="p">SVG also stores information outside the <code>viewBox</code> area. If we move a shape outside this space, we’ll see what’s shown in <a data-type="xref" href="part0006_split_002.html#fig1.4" className="calibre7">Figure 1-4</a>.</p>
...
<p className="it">Hay un aspecto más de la <code>viewBox</code> que debería tener en cuenta, invisible en este ejemplo. La mayoría de los IVS se pueden ver en la web ni siquiera se especifican porque el valor por defecto, <code>preserveAspectRatio="xMidYMid meet</code> es lo que la mayoría de la gente quiere más de 9 veces de 10. Este<a contenteditable="false" data-primary="preserveAspectRatio=&quot;xMidYMidmeet&quot;" data-type="indexterm" id="idm140658634246736" className="calibre7"></a>obliga al área de dibujo para ajustarse con uniforme <a contenteditable="false" data-primary="viewBox" data-startref="v1" data-type="indexterm" id="idm140658634242896" className="calibre7"></a>escalada.</p>
<p className="p">There is one more aspect of <code>viewBox</code> you should be aware of, invisible in this example. Most SVGs you will see on the web won’t even specify it because the default, <code>preserveAspectRatio="xMidYMid meet</code>, is what most people will want more than 9 times out of 10. This <a contenteditable="false" data-primary="preserveAspectRatio=&quot;xMidYMidmeet&quot;" data-type="indexterm" id="idm140658634246736" className="calibre7"></a>forces the drawing area to adjust itself with uniform <a contenteditable="false" data-primary="viewBox" data-startref="v1" data-type="indexterm" id="idm140658634242896" className="calibre7"></a>scaling.</p>

<p className="it">Hay varias otras opciones también. El primer parámetro, <code>xMidYMid</code>,<a contenteditable="false" data-primary="xMidYMid" data-type="indexterm" id="idm140658634241392" className="calibre7"></a>determina si o no a escala de manera uniforme el elemento, y que parte de la ventana gráfica a escala a partir de, en <a contenteditable="false" data-primary="camelCase" data-type="indexterm" id="idm140658634240032" className="calibre7"></a>camel case (estilo como este: camelCase). El valor por defecto es a escala del centro, o <code>Mid</code>, pero hay varias otras opciones de alineación, tales como <code>xMinYMax</code>. También puede designar <code>none</code>, en cuyo caso se tendrá en cuenta la relación de aspecto en sus porcentajes predeterminados, y el elemento será aplastado o estirado para llenar el espacio disponible.</p>
<p className="p">There are several other options as well. The first parameter, <code>xMidYMid</code>, <a contenteditable="false" data-primary="xMidYMid" data-type="indexterm" id="idm140658634241392" className="calibre7"></a>determines whether or not to uniformly scale the element, and which part of the viewport to scale from, in <a contenteditable="false" data-primary="camelCase" data-type="indexterm" id="idm140658634240032" className="calibre7"></a>camel case (styled like this: camelCase). The default is to scale from the center, or <code>Mid</code>, but there are several other alignment options, such as <code>xMinYMax</code>. You may also designate <code>none</code>, in which case the aspect ratio at its default percentages will be ignored, and the element will be squashed or stretched to fill the available space.</p>

<p className="it">El segundo parámetro puede ser&nbsp; <code>meet</code> o <code>slice</code>.<code>meet</code> <a contenteditable="false" data-primary="meet" data-type="indexterm" id="idm140658634236496" className="calibre7"></a><a contenteditable="false" data-primary="slice" data-type="indexterm" id="idm140658634235520" className="calibre7"></a>intentará escalar el gráfico tanto como sea posible para encajar dentro de la que contiene <code>viewBox</code>, mientras se mantiene la relación de aspecto consistente. Esta funcionalidad es similar a la&nbsp; <code>background-size: contain</code>&nbsp;de la imagen que permanecerá contenida en los límites de la unidad que contiene.</p>
<p className="p">The second parameter can be either <code>meet</code> or <code>slice</code>. <code>meet</code> <a contenteditable="false" data-primary="meet" data-type="indexterm" id="idm140658634236496" className="calibre7"></a><a contenteditable="false" data-primary="slice" data-type="indexterm" id="idm140658634235520" className="calibre7"></a>will attempt to scale the graphic as much as possible to fit inside the containing <code>viewBox</code>, while keeping the aspect ratio consistent. This functionality is similar to <code>background-size: contain</code> in that the image will stay contained in the boundaries of the containing unit.</p>

<p className="it"><code>slice</code> permitirá que el gráfico dentro del <code>viewBox</code> expandirse más allá de lo que el usuario ve en la dirección especificada, mientras que el llenado hasta el área disponible. Se puede pensar en ello como&nbsp; <code>background-size: cover</code> en la imagen que va a empujar más allá de los límites de la unidad que contiene para llenar el espacio disponible para el usuario.</p>
<p className="p"><code>slice</code> will allow the graphic within the <code>viewBox</code> to expand beyond what the user sees in the direction specified, while filling up the available area. You can think about it like <code>background-size: cover</code> in that the image will push beyond the boundaries of the containing unit to fill up the available user space.</p>
...
<p className="it">Joni Trythall tiene <a href="http://bit.ly/2m8bULb" className="calibre7">un muy buen recurso sobre el <code>viewBox</code> y visor así</a> .</p>
<p className="p">Joni Trythall has <a href="http://bit.ly/2m8bULb" className="calibre7">a really nice resource about the <code>viewBox</code> and viewport as well</a>.</p>
</div>
<div className="praise" id="idm140658634267248">
<h1 className="calibre12" id="calibre_pb_4">Drawing Shapes</h1>

<p className="it">Dentro <a contenteditable="false" data-primary="shapes" data-secondary="drawing" data-type="indexterm" id="s1d" className="calibre7"></a>nuestra SVG, hemos definido cinco formas. <code>rect</code> <a contenteditable="false" data-primary="rect" data-type="indexterm" id="idm140658634170528" className="calibre7"></a>se refiere a un rectángulo o un cuadrado. Las <code>x</code> y los <code>y</code> valores, al igual que con el SVG en sí, son donde comienza la forma: en este caso, su esquina superior izquierda. Anchura y la altura de la forma utilizan el mismo sistema de coordenadas:</p>
<p className="p">Within <a contenteditable="false" data-primary="shapes" data-secondary="drawing" data-type="indexterm" id="s1d" className="calibre7"></a>our SVG, we’ve defined five shapes. <code>rect</code> <a contenteditable="false" data-primary="rect" data-type="indexterm" id="idm140658634170528" className="calibre7"></a>refers to a rectangle or square. The <code>x</code> and <code>y</code> values, just as with the SVG itself, are where the shape begins: in this case, its upper-left corner. The shape’s width and height use the same coordinate system:</p>

<pre className="programlisting">
&lt;rect x="10" y="5" fill="white" stroke="black" width="90" height="90"/&gt;</pre>

<p className="it">los <a contenteditable="false" data-primary="fill" data-type="indexterm" id="idm140658634167392" className="calibre7"></a>y llenar el <a contenteditable="false" data-primary="stroke" data-type="indexterm" id="idm140658634165872" className="calibre7"></a>accidente cerebrovascular se designan aquí como <code>white</code> y <code>black</code>; si no se ha especificado aquí, el relleno sería por defecto a negro y la carrera sería ninguna (es decir, invisible).</p>
<p className="p">The <a contenteditable="false" data-primary="fill" data-type="indexterm" id="idm140658634167392" className="calibre7"></a>fill and the <a contenteditable="false" data-primary="stroke" data-type="indexterm" id="idm140658634165872" className="calibre7"></a>stroke are designated here as <code>white</code> and <code>black</code>; if nothing was specified here, the fill would default to black and the stroke would be none (i.e., invisible).</p>

<p className="it"><code>circle</code> se refiere <a contenteditable="false" data-primary="circle" data-type="indexterm" id="idm140658634163024" className="calibre7"></a>a-lo adivinaste-un círculo:</p>
<p className="p"><code>circle</code> refers <a contenteditable="false" data-primary="circle" data-type="indexterm" id="idm140658634163024" className="calibre7"></a>to—you guessed it—a circle:</p>

<pre className="programlisting">
&lt;circle fill="white" stroke="black" cx="170" cy="50" r="45"/&gt;</pre>

<p className="it"><code>cx</code> es el punto donde el centro del círculo se encuentra en el <code>x</code> eje x, <code>cy</code> es el punto en el centro del círculo se encuentra en el <code>y</code> eje x, y <code>r</code> es el radio. También se puede utilizar <code>ellipse</code> para las formas ovales, la única diferencia es que hay dos valores de radio: <code>rx</code> y <code>ry</code>.</p>
<p className="p"><code>cx</code> is the point where the center of the circle lies on the <code>x</code>-axis, <code>cy</code> is the point where the center of the circle lies on the <code>y</code>-axis, and <code>r</code> is the radius. You can also use <code>ellipse</code> for oval shapes, the only difference being there are two radius values: <code>rx</code> and <code>ry</code>.</p>

<p className="it"><code>polygon</code> pases <a contenteditable="false" data-primary="polygon" data-type="indexterm" id="idm140658634155936" className="calibre7"></a>una matriz de valores en una lista separada por espacios, definido por los puntos:</p>
<p className="p"><code>polygon</code> passes <a contenteditable="false" data-primary="polygon" data-type="indexterm" id="idm140658634155936" className="calibre7"></a>an array of values in a space-separated list, defined by points:</p>
...
<p className="it">El primer punto de una línea se representa en las <code>x1</code> y <code>y1</code> los valores, y el final de la línea en el <code>x2</code> y <code>y2</code> valores. Me he mostrado dos líneas aquí, así que se puede ver que la sintaxis se mantiene consistente si la línea es recta o diagonal. En términos de código, que no quería que mirar las líneas<a contenteditable="false" data-primary="shapes, drawing" data-startref="s1d" data-type="indexterm" id="idm140658634159136" className="calibre7"></a>oblicuo.</p>
<p className="p">The first point of a line is plotted at the <code>x1</code> and <code>y1</code> values, and the end of the line at the <code>x2</code> and <code>y2</code> values. I’ve shown two lines here so you can see that the syntax stays consistent whether the line is straight or diagonal. In terms of code, I didn’t want you looking at lines <a contenteditable="false" data-primary="shapes, drawing" data-startref="s1d" data-type="indexterm" id="idm140658634159136" className="calibre7"></a>sideways.</p>
</div>
...
<p className="it">El SVG ahora puede escalar en unidades porcentuales o de ventana gráfica, e incluso puede ser afectada por las consultas de los medios de comunicación. El único problema es que se debe declarar una <code>viewBox</code> <a contenteditable="false" data-primary="viewBox" data-secondary="declaring" data-type="indexterm" id="idm140658634133648" className="calibre7"></a>en este caso: ya no es opcional. El comportamiento predeterminado de un SVG con <code>width</code> y <code>height</code> removido y un <code>viewBox</code> declarado es a escala de los parámetros máximos del elemento contenedor, que puede ser el cuerpo, un div o cualquier otra cosa.</p>
<p className="p">The SVG can now scale in percentage or viewport units, and can even be affected by media queries. The one catch is that you must declare a <code>viewBox</code> <a contenteditable="false" data-primary="viewBox" data-secondary="declaring" data-type="indexterm" id="idm140658634133648" className="calibre7"></a>in this instance: it is no longer optional. The default behavior of an SVG with <code>width</code> and <code>height</code> removed and a <code>viewBox</code> declared is to scale to the maximum parameters of the containing element, which may be the body, a div, or just about anything else.</p>

<p className="it">La segunda cosa que me gustaría señalar es <a contenteditable="false" data-primary="g element" data-type="indexterm" id="idm140658634128368" className="calibre7"></a>el <code>&lt;g&gt;</code> elemento. <code>g</code> es sinónimo de <em className="calibre2">grupo</em>, y es una forma de nido y ensamblar múltiples elementos juntos en el DOM SVG. También se puede notar que en lugar de definir el relleno y el trazo en los propios elementos, por lo que hemos hecho en el grupo, y se puede ver que aplica a través de los descendientes.</p>
<p className="p">The second thing I’d like to point out is <a contenteditable="false" data-primary="g element" data-type="indexterm" id="idm140658634128368" className="calibre7"></a>the <code>&lt;g&gt;</code> element. <code>g</code> stands for <em className="calibre2">group</em>, and it’s a way to nest and assemble multiple elements together in the SVG DOM. You may also notice that rather than defining the fill and stroke on elements themselves, we’ve done so on the group, and you can see it applied across the descendants.</p>

<p className="it">La última y muy pertinente que hay que destacar es la sintaxis de la vía. los<a contenteditable="false" data-primary="paths" data-type="indexterm" id="p1" className="calibre7"></a>ruta comienza con <code>d</code>, por <em className="calibre2">los datos</em>, y siempre se designa con<a contenteditable="false" data-primary="moveTo" data-type="indexterm" id="idm140658634123040" className="calibre7"></a>el <code>M</code> o <code>m</code> (por <code>moveTo</code> orden) como el primer valor. Esto establece un nuevo punto. A diferencia de la hora de crear un polígono / polilínea, sin embargo las coordenadas especificadas aquí no son siempre puntos de la recta final.</p>
<p className="p">The last and very pertinent thing to note is the path syntax. The <a contenteditable="false" data-primary="paths" data-type="indexterm" id="p1" className="calibre7"></a>path begins with <code>d</code>, for <em className="calibre2">data</em>, and is always designated with <a contenteditable="false" data-primary="moveTo" data-type="indexterm" id="idm140658634123040" className="calibre7"></a>the <code>M</code> or <code>m</code> (for <code>moveTo</code>) command as the first value. This establishes a new point. Unlike when creating a polygon/polyline, however the coordinates specified here are not always points on the final line.</p>
...
<table id="table1.1" className="calibre29">
	...
	<tbody className="calibre34">
		<tr className="calibre32">
			<td className="calibre35"><code>M, m</code></td>
			<td className="calibre35"><code>moveTo</code></td>
			<td className="calibre35">Start of the path</td>
		</tr>
		<tr className="calibre36">
			<td className="calibre35"><code>L, l</code></td>
			<td className="calibre35"><code>lineTo</code></td>
		...
		<tr className="calibre32">
			<td className="calibre35"><code>H, h</code></td>
		...
		<tr className="calibre36">
			<td className="calibre35"><code>V, v</code></td>
		...
		<tr className="calibre32">
			<td className="calibre35"><code>Z, z</code></td>
			<td className="calibre35">Joins the end of a path to the most recent <code>moveTo</code> command</td>
		...
		<tr className="calibre32">
			<td className="calibre35"><code>C, c</code></td>
		...
		<tr className="calibre36">
			<td className="calibre35"><code>S, s</code></td>
		...
		<tr className="calibre32">
			<td className="calibre35"><code>Q, q</code></td>
		...
		<tr className="calibre36">
			<td className="calibre35"><code>T, t</code></td>
		...
		<tr className="calibre32">
			<td className="calibre35"><code>A,a</code></td>
...
<p className="it">revisando <a contenteditable="false" data-primary="paths" data-startref="p1" data-type="indexterm" id="idm140658634083728" className="calibre7"></a><a data-type="xref" href="part0006_split_005.html#fig1.5" className="calibre7">Figura 1-5</a> y su código, se puede ver la diferencia entre los caminos por señalar que uno tiene una <code>z</code> en el extremo de sus datos de la trayectoria.</p>
<p className="p">Revisiting <a contenteditable="false" data-primary="paths" data-startref="p1" data-type="indexterm" id="idm140658634083728" className="calibre7"></a><a data-type="xref" href="part0006_split_005.html#fig1.5" className="calibre7">Figure 1-5</a> and its code, you can see the difference between the paths by noting which one has a <code>z</code> at the end of its path data.</p>
...
<p className="it">Si <code>x</code> y <code>y</code> se definen como <code>0</code> (suele ser el caso), podemos despojar a los fuera, también. El único caso en el que nos gustaría dejarlos en si es que estamos trabajando con un niño SVG anidado dentro de otro SVG.</p>
<p className="p">If <code>x</code> and <code>y</code> are defined as <code>0</code> (usually the case), we can strip those out, too. The only case where we’d want to leave them in is if we’re working with a child SVG nested inside another SVG.</p>
